...
Evaluasi model klasifikasi biner menunjukkan perubahan signifikan setelah proses tuning. Sebelum tuning, model memiliki akurasi keseluruhan 74.22%, dengan performa yang cukup baik untuk kelas mayoritas (kelas 0, "Tidak Gagal Bayar") yang ditunjukkan oleh F1-Score 0.8240, serta presisi 0.8798 dan recall 0.7748. Namun, model menunjukkan kesulitan dengan kelas minoritas (kelas 1, "Gagal Bayar"), yang terlihat dari presisi yang rendah (0.4418) dan F1-Score yang moderat (0.5185), meskipun recall masih 0.6275.

Setelah tuning, akurasi model meningkat tajam menjadi 82%. Performa untuk kelas mayoritas (kelas 0) semakin membaik dengan F1-Score 0.89 dan peningkatan recall yang signifikan menjadi 0.96 (meskipun presisi sedikit menurun menjadi 0.84). Namun, peningkatan ini datang dengan trade-off pada kelas minoritas (kelas 1): presisi meningkat drastis menjadi 0.68, menunjukkan bahwa prediksi "Gagal Bayar" model lebih akurat, tetapi recall menurun tajam menjadi 0.34. Penurunan recall yang signifikan ini menyebabkan F1-Score kelas 1 sedikit menurun menjadi 0.45. Hal ini mengindikasikan bahwa meskipun model lebih presisi dalam mengidentifikasi "Gagal Bayar", ia kini melewatkan lebih banyak kasus "Gagal Bayar" yang sebenarnya. Kondisi ketidakseimbangan kelas (4667 sampel kelas 0 vs. 1326 sampel kelas 1) kemungkinan masih menjadi tantangan, dan proses tuning yang dilakukan tampaknya mengoptimalkan performa untuk kelas mayoritas secara lebih kuat, mengorbankan kemampuan model untuk menangkap semua kasus kelas minoritas.
